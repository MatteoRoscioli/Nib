...
SD Card Support - Read files from FAT32 formatted micro SD cards
...
Based on bare-metal ARM programming techniques and MicroPython.


Nib OS - Lightweight, bare-metal computing for Raspberry Pi.
